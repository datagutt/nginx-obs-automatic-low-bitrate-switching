...
class Chat {
  ...
  rec(bool) {
    ...
    if (!bool) {
      this.say("[REC] ".concat(this.obsProps.obsRecording ? this.locale.rec.started : this.locale.rec.stopped));
      return;
    }
  ...
  startStopRec(bool) {
    ...
    return _asyncToGenerator(function* () {
      if (bool) {
        try {
          var res = yield _this3.obs.toggleRecording();
        ...
        try {
          var _res = yield _this3.obs.toggleRecording();
